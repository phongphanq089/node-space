    ...
    <div className="flex h-full flex-col overflow-hidden rounded-xl border border-ns-border bg-ns-panel shadow-lg">
      ...
      <div className="flex items-center justify-between border-b border-ns-border-soft px-4 py-3">
        <div className="flex items-center gap-2">
          ...
          <span className="rounded-full bg-ns-active px-2 py-0.5 text-[0.62rem] font-semibold text-ns-primary-lt">
            6 notes
          </span>
        </div>
        <div className="flex gap-1.5 text-ns-ghost">
          <button
            className="flex h-7 w-7 cursor-pointer items-center justify-center rounded-lg transition-colors hover:bg-ns-hover hover:text-ns-primary-lt"
            title="Filter"
          >
            <Filter size={13} />
          </button>
            ...
            <div className="min-w-0 flex-1">
              <div className="flex items-center justify-between gap-1.5">
                ...
                <div className="flex flex-shrink-0 items-center gap-1.5">
                  ...
                  <button className="cursor-pointer text-ns-ghost opacity-0 transition-opacity group-hover:opacity-100 hover:text-ns-primary-lt">
              ...
              <div className="mt-1.5 flex flex-wrap gap-1">
                {note.tags.map((t) => (
                  <span
                    key={t}
                    className="rounded-md border border-ns-border/40 bg-ns-hover/80 px-1.5 py-0.5 text-[0.58rem] font-semibold text-ns-primary-lt"
                  >
                    {t}
                  </span>
                ))}
