...
export function FolderCardSkeleton() {
  return (
    <div className="flex items-stretch gap-4 rounded-2xl border border-ns-border/30 bg-ns-panel/60 p-4 shadow-lg backdrop-blur-md">
      ...
      <Skeleton className="h-24 w-24 flex-shrink-0 rounded-2xl bg-ns-surface/80" />
      ...
      <div className="flex min-w-0 flex-1 flex-col justify-between">
        ...
        <div className="flex items-start justify-between gap-2">
          ...
          <Skeleton className="h-4 w-4 rounded-md bg-ns-surface/80" />
        </div>

        {/* Date */}
        <div className="mt-1 flex items-center gap-1.5">
          <Skeleton className="h-3 w-28 rounded-md bg-ns-surface/60" />
        </div>

        {/* Notes Count Badge */}
        <div className="mt-2.5 flex items-center justify-between">
          <Skeleton className="h-4 w-16 rounded-md bg-ns-surface/60" />
        </div>
